import{c as k}from"./index-99b0b950.js";const a=new Set;let y=!1,c=!1;const t={keys:{},controlling:!1,shift:0,space:0,r:0,x:0,y:0},s=(r,e)=>{const o=r.toLowerCase();switch(o){case"s":case"arrowdown":t.y=-1*e;break;case"w":case"arrowup":t.y=1*e;break;case"a":case"arrowleft":t.x=-1*e;break;case"d":case"arrowright":t.x=1*e;break;case" ":t.space=1*e;break;case"q":t.r=1*e;break;case"e":t.r=-1*e;break;case"shift":t.shift=1*e;break}e===1?t.keys[o]=!0:delete t.keys[o]},f=r=>{c&&(r.preventDefault(),r.stopImmediatePropagation());const e=r.key.toLowerCase();t.controlling=!0,a.add(e);for(const o of a)s(o,1)},u=r=>{c&&(r.preventDefault(),r.stopImmediatePropagation());const e=r.key.toLowerCase();a.delete(e),s(e,0);for(const o of a)s(o,1);a.size===0&&(t.controlling=!1)},p=()=>{for(const r of a)s(r,0);a.clear()},m=()=>{window.removeEventListener("keydown",f),window.removeEventListener("keyup",u),window.addEventListener("blur",p),y=!1},b=(r={})=>(c=r.preventDefault??!0,y||(window.addEventListener("keydown",f),window.addEventListener("keyup",u),window.addEventListener("blur",p)),{keyboard:t,disposeKeyboard:m}),K=`import { useKeyboard } from 'trzy'
...
//# sourceMappingURL=index.stories-9a05c3da.js.map
