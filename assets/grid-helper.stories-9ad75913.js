var g=Object.defineProperty;var f=(i,r,e)=>r in i?g(i,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[r]=e;var a=(i,r,e)=>(f(i,typeof r!="symbol"?r+"":r,e),e);import{b as v,P as p,l as z,D as C,C as S,s as h,u as w}from"./setup-bf23c97c.js";var x=`varying vec3 worldPosition;
...
`,H={title:"Grid Helper",parameters:{docs:{description:{component:"Similar to `THREE.GridHelper` but is just a single plane with lines rendered on the GPU."},source:{code:G}}}},_=()=>{h();const{scene:i,renderer:r}=w();return i.add(new y(1,10,"white")),r.domElement},n={render:_};var o,l,s;n.parameters={...n.parameters,docs:{...(o=n.parameters)==null?void 0:o.docs,source:{originalSource:`{
  render
}`,...(s=(l=n.parameters)==null?void 0:l.docs)==null?void 0:s.source}}};const b=["Primary"];export{n as Primary,b as __namedExportsOrder,H as default};
//# sourceMappingURL=grid-helper.stories-9ad75913.js.map
