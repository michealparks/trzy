import{l as r,a as v}from"./index-b1a306c2.js";import{s as S}from"./lib-557be54d.js";var m=`#define RGB_NOISE_FUNCTION(uv) (randRgb(uv))
...
resetSoftShadows()
`,E={title:"Soft Shadows",parameters:{docs:{source:{code:g}}}},R=()=>{h();const{scene:e,camera:n,canvas:t,renderer:a,update:o}=v();return p(a,e,n.current),S({scene:e,camera:n,canvas:t,update:o,controls:!0}).then(()=>{const l=e.getObjectByName("Strawberry");o(()=>{l.rotation.y+=.05})}),a.domElement},s={render:R};var i,d,u;s.parameters={...s.parameters,docs:{...(i=s.parameters)==null?void 0:i.docs,source:{originalSource:`{
  render
...
//# sourceMappingURL=index.stories-f9a9bbc7.js.map
