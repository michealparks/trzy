var g=Object.defineProperty;var f=(i,r,e)=>r in i?g(i,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[r]=e;var a=(i,r,e)=>(f(i,typeof r!="symbol"?r+"":r,e),e);import{M as v,P as p,k as z,D as C,C as S,s as h,u as w}from"./setup-d3d63792.js";var x=`varying vec3 worldPosition;
...
`,H={title:"Grid Helper",parameters:{docs:{description:{component:"Similar to `THREE.GridHelper` but is just a single plane with lines rendered on the GPU."},source:{code:_}}}},y=()=>{h();const{scene:i,renderer:r}=w();return i.add(new G(1,10,"white")),r.domElement},n={render:y};var t,l,s;n.parameters={...n.parameters,docs:{...(t=n.parameters)==null?void 0:t.docs,source:{originalSource:`{
  render
}`,...(s=(l=n.parameters)==null?void 0:l.docs)==null?void 0:s.source}}};const F=["Primary"];export{n as Primary,F as __namedExportsOrder,H as default};
//# sourceMappingURL=index.stories-f6e27e47.js.map
