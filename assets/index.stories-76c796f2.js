...
// later
disposeGamepads()
`,N={title:"Gamepad",parameters:{docs:{source:{code:H}}}},J=()=>{const{update:e}=Y(),t=document.createElement("div");t.style.display="flex";const a=document.createElement("pre"),n=document.createElement("pre");a.style.width="400px",t.append(a,n);const{gamepad1:r,gamepad2:c,updateGamepads:l}=A();return e(()=>{l(),a.innerHTML=`Gamepad 1

${JSON.stringify(r,null,2)}`,n.innerHTML=`Gamepad 2

${JSON.stringify(c,null,2)}`}),t},s={render:J};var w,B,y;s.parameters={...s.parameters,docs:{...(w=s.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render
...
//# sourceMappingURL=index.stories-76c796f2.js.map
