var g=Object.defineProperty;var f=(n,r,e)=>r in n?g(n,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[r]=e;var a=(n,r,e)=>(f(n,typeof r!="symbol"?r+"":r,e),e);import{M as v,P as p,S as z,D as C,C as S,s as h,u as w}from"./setup-9d42791d.js";var x=`varying vec3 worldPosition;
...
`,H={title:"Grid Helper",parameters:{docs:{description:{component:"Similar to `THREE.GridHelper` but is just a single plane with lines rendered on the GPU."},source:{code:_}}}},y=()=>{h();const{scene:n,renderer:r}=w();return n.add(new G(1,10,"white")),r.domElement},i={render:y};var t,l,s;i.parameters={...i.parameters,docs:{...(t=i.parameters)==null?void 0:t.docs,source:{originalSource:`{
  render
}`,...(s=(l=i.parameters)==null?void 0:l.docs)==null?void 0:s.source}}};const F=["Primary"];export{i as Primary,F as __namedExportsOrder,H as default};
//# sourceMappingURL=index.stories-c63280a3.js.map
